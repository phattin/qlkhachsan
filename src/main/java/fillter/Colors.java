...
public class Colors {
    ...
    public static final Color MAIN_BUTTON = new Color(0,191,255); //Xanh nhat
    public static final Color HOVER_BUTTON = new Color(0,191,255);//Xam nhat
    public static final Color BORDER = new Color(0, 0, 0);//den
