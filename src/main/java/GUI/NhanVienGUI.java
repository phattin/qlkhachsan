...
public class NhanVienGUI extends JPanel {
    ...
    private void loadTableDataTaiKhoan(ArrayList<TaiKhoanDTO> danhSachTaiKhoan) {
        DefaultTableModel tableModelTK = TaiKhoanGUI.getTableTaiKhoan();
        ...
        btnOk.addActionListener(e -> {
            try {
                ...
                if (nvBUS.add(nv) && tkBUS.add(tk)) {
                    ...
                    dialog.dispose();
                    loadTableData(NhanVienBUS.getAllNhanVien());
                    loadTableDataTaiKhoan(TaiKhoanBUS.getAllTaiKhoan());
                } else {
