...
public class KhachHangGUI extends JPanel {
    ...
    private void themKhachHang() {
        ...
        btnAdd.addActionListener(e -> {
            ...
            if (khachHangBUS.isMaKHExists(maKH)) {
                JOptionPane.showMessageDialog(dialog, "Mã khách hàng đã tồn tại! Vui lòng nhập mã khác.", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (!cccd.matches("\\d{9,12}")) {
                JOptionPane.showMessageDialog(dialog, "CCCD phải có từ 9 đến 12 chữ số!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            if (!sdt.matches("\\d{10,11}")) {
                JOptionPane.showMessageDialog(dialog, "Số điện thoại phải có từ 10 đến 11 chữ số!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            if (diaChi.isEmpty()) {
                JOptionPane.showMessageDialog(dialog, "Địa chỉ không được để trống!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
    ...
    private void suaKhachHang() {
        ...
        btnSave.addActionListener(e -> {
            ...
            if (!emailMoi.isEmpty() && !emailMoi.matches("^[\\w.-]+@[\\w.-]+\\.[a-zA-Z]{2,}$")) {
                JOptionPane.showMessageDialog(dialog, "Email không hợp lệ!", "Lỗi", JOptionPane.ERROR_MESSAGE);
                return;
            }
