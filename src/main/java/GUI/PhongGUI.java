...
public class PhongGUI extends JPanel {
    ...
    public PhongGUI() {
        ...
        String[] columnNames = {"Mã Phòng", "Mã Loại Phòng", "Loại Phòng", "Số Giường", "Giá Tiền", "Trạng Thái"};
    ...
    public void loadTableData() {
        ...
        for (PhongDTO phong : danhSachPhong) {
            LoaiPhongDTO loaiPhong = phongBUS.getLoaiPhongByMaPhong(phong.getMaPhong());
            String giaTienFormatted = decimalFormat.format(loaiPhong.getGiaPhong()) + " VNĐ";
    ...
    private void addNewRoom() {
        ...
        btnAdd.addActionListener(e -> {
            ...
            // Tạo đối tượng mới
            PhongDTO phong = new PhongDTO(maPhong, maLoaiPhong, trangThai, 0);
