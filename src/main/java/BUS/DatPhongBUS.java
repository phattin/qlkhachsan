...
public class DatPhongBUS {
    ...
    private DanhSachPhongBUS danhSachPhongBUS;

    public DatPhongBUS() {
        datPhongDAO = new DatPhongDAO();
        danhSachPhongBUS = new DanhSachPhongBUS();
    }
    ...
    public boolean xoaMemDatPhong(String maDatPhong) {
        return datPhongDAO.xoaMemDatPhong(maDatPhong);
    }
    ...
    public List<DatPhongDTO> layDanhSachDatPhongTuDanhSachPhong(String maPhong) {
        return datPhongDAO.layDanhSachDatPhongTuDanhSachPhong(maPhong);
    }

    public String increaseMaDatPhong() {
        return datPhongDAO.increaseMaDatPhong();
    }
}